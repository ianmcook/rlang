...
test_that("long vectors are truncated when max_len = 0L", {
  expect_identical(sexp_deparse(1:10, max_len = 0L), "<int: ...>")
  expect_identical(sexp_deparse(as.list(1:10), max_len = 0L), "<list: ...>")
})

test_that("long vectors are not truncated when max_len = NULL", {
  expect_identical(sexp_deparse(1:10, max_len = NULL), "<int: 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L>")
  expect_identical(sexp_deparse(as.list(1:10), max_len = NULL), "<list: 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L>")
})
