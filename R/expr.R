...
#' @param max_len Maximum length of a vector or list before truncation
...
expr_print <- function(x, width = peek_option("width"), max_len = 5L) {
  cat_line(expr_deparse(x, width = width, max_len = max_len))
}
#' @rdname expr_print
#' @export
